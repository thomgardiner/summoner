...
impl Fixture {
    ...
    fn fake_tools(&self) {
        fake(
            &self.bin,
            "grove",
            r#"if [ "$1" = "--version" ]; then echo 'grove 0.3.4'; exit 0; fi
if [ "$1" = "capabilities" ]; then echo '{"schema_version":1,"grove_version":"0.3.4","status":{"repository_schema":1,"task_status_schema":3,"task_record_schema":5},"inspection":{"binding_schema":1,"execution_schema":1,"process_tree":"unix_process_group_best_effort","filesystem":"read_only_permissions_and_digest","output":"captured_logs_json_report","finish_source_cas":true}}'; exit 0; fi
...
exit 1"#,
            r#"if "%1"=="--version" (echo grove 0.3.4& exit /b 0)
if "%1"=="capabilities" (echo {"schema_version":1,"grove_version":"0.3.4","status":{"repository_schema":1,"task_status_schema":3,"task_record_schema":5},"inspection":{"binding_schema":1,"execution_schema":1,"process_tree":"windows_job_object","filesystem":"read_only_permissions_and_digest","output":"captured_logs_json_report","finish_source_cas":true}}& exit /b 0)
